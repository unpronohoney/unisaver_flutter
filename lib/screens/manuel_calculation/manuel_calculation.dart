...
class ManuelCalcPage extends StatefulWidget {
  const ManuelCalcPage({super.key});

  @override
  State<ManuelCalcPage> createState() => _ManuelHesapPageState();
}

class _ManuelHesapPageState extends State<ManuelCalcPage> {
