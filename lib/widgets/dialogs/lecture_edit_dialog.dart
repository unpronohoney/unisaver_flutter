...
void showEditDialog(
  ...
  showModalBottomSheet(
    context: context,
    isScrollControlled: true, // Klavye açıldığında tam boyu kullanabilmesi için şart
    backgroundColor: Colors.transparent,
    builder: (context) {
      // 1. HAMLE: Klavye kadar padding veriyoruz
      return Padding(
        ...
        child: Container(
          ...
          // 2. HAMLE: İçerik taşarsa scroll edilebilir olsun
